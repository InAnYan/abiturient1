...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.IntegerField(choices=[(1, 'Bachelor'), (2, 'Master')], verbose_name='Educational level')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, verbose_name='Name')),
                ('specialization_code', models.IntegerField(blank=True, null=True, verbose_name='Specialization code')),
                ('specialization_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Specialization name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveIntegerField(choices=[(1, 'Bachelor'), (2, 'Master')], verbose_name='Educational level')),
                ...
                ('year1_cost', models.PositiveIntegerField(default=0, verbose_name='Year 1 cost (for Masters it is semester 1 cost)')),
                ('year2_cost', models.PositiveIntegerField(default=0, verbose_name='Year 2 cost (for Masters it is semester 2 cost)')),
                ('year3_cost', models.PositiveIntegerField(default=0, verbose_name='Year 3 cost (for Masters it is semester 3 cost)')),
                ('year4_cost', models.PositiveIntegerField(default=0, verbose_name='Year 4 cost (for Masters it is semester 4 cost)')),
                ('educational_program', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='university_offers.educationalprogram', verbose_name='Educational program')),
            ],
            options={
